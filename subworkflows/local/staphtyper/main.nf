//
// Determine the agr, spa and SCCMEC types for S. aureus assemblies
//
...
include { AGRVATE } from '../../../modules/nf-core/modules/agrvate/main' addParams( options: [args: "${argvate_args}", subworkflow: "staphtyper"] )
include { SPATYPER } from '../../../modules/nf-core/modules/spatyper/main' addParams( options: [args: "${spatyper_args}", subworkflow: "staphtyper"] )
include { STAPHOPIASCCMEC } from '../../../modules/nf-core/modules/staphopiasccmec/main' addParams( options: [args: "${staphopiasccmec_args}", subworkflow: "staphtyper"] )
...
workflow STAPHTYPER {
    ...
    if (params.workflows[params.wf].is_subworkflow == true) {
        // Merge AgrVATE
        //AGRVATE.out.tsv.collect{meta, summary -> summary}.map{ summary -> [[id:'spatyper'], summary]}.set{ ch_merge_agrvate }
