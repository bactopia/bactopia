...
include { ARIBA_GETREF } from '../../../modules/nf-core/modules/ariba/getref/main' addParams( )
include { ARIBA_RUN } from '../../../modules/nf-core/modules/ariba/run/main' addParams( options: options )

if (params.is_subworkflow) {
    include { CSVTK_CONCAT as CSVTK_CONCAT_REPORT } from '../../../modules/nf-core/modules/csvtk/concat/main' addParams( options: [args: '-C "#"', publish_to_base: true, logs_subdir: options.is_module ? '' : 'ariba'] )
    include { CSVTK_CONCAT as CSVTK_CONCAT_SUMMARY } from '../../../modules/nf-core/modules/csvtk/concat/main' addParams( options: [args: '-C "#"', publish_to_base: true, logs_subdir: options.is_module ? '' : 'ariba'] )
}
