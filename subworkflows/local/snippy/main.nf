...
core_opts.subdir = "${params.run_name}"
...
include { GUBBINS } from '../gubbins/main' addParams( options: [subdir:params.run_name, suffix: 'core-snp', ignore: [".aln.gz"], publish_to_base: [".masked.aln.gz"]] )
include { IQTREE } from '../iqtree/main' addParams( options: [subdir:params.run_name, suffix: 'core-snp', ignore: [".aln.gz"], publish_to_base: [".iqtree"]] )
include { SNPDISTS } from '../../../modules/nf-core/snpdists/main' addParams( options: [subdir:params.run_name, suffix: 'core-snp.distance', publish_to_base: true] )
