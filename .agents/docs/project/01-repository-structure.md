...
```
bactopia/
├── .agents/                   # AI context: docs/ (modular documentation) and skills/
├── .claude/                   # Compatibility symlink: skills -> ../.agents/skills
...
├── AGENTS.md                  # AI Context Master Map (agents.md standard)
├── CLAUDE.md                  # One-line compatibility pointer importing AGENTS.md
...
- Bactopia Tools in `workflows/bactopia-tools/` (70 tools; 74 workflows total across all tiers)
