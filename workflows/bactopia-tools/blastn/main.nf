...
workflow {
    main:
    BACTOPIATOOL_INIT()
    BLASTN(BACTOPIATOOL_INIT.out.blastdb, params.blastn_query)

    ch_sample_nf_logs = collectNextflowLogs(BLASTN.out.sample_outputs)
    ch_run_nf_logs = collectNextflowLogs(BLASTN.out.run_outputs)
