...
update_environment "assemble_genome" "shovill-se=1.1.0se dragonflye=1.0.5 nanoq=0.8.2 unicycler=0.4.8 bowtie2=2.3.5.1" ${CONDA_DIR} ${DOCKER_DIR} ${VERSION} ${IS_MAC}
if [ "${IS_MAC}" == "1" ]; then
