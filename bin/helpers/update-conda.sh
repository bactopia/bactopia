...
if [ "${IS_MAC}" == "1" ]; then
    ...
    update_environment "call_variants" "snippy=4.6.0 vcf-annotator=0.7 mash=2.3 ncbi-genome-download=0.3.1 biopython=1.77 snpeff=5.0 rename gsl=2.6" ${CONDA_DIR} ${IS_MAC}
else
    ...
    update_environment "call_variants" "snippy=4.6.0 vcf-annotator=0.7 vt=2015.11.10=he941832_3 mash=2.3 ncbi-genome-download=0.3.1 biopython=1.77 snpeff=5.0 rename gsl=2.6" ${CONDA_DIR} ${IS_MAC}
fi
