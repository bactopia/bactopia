...
update_environment "gather_samples" "sra-tools=2.11.0 bbmap=38.96 art=2016.06.05 mash=2.3 ncbi-genome-download=0.3.1 fastq-dl=1.1.1 fastq-scan=1.0.0 fastqc=0.11.9 lighter=1.1.2 porechop=0.2.4 nanoq=0.9.0 nanoplot=1.39.0 rasusa=0.6.1 biopython=1.77 rename" ${CONDA_DIR} ${IS_MAC}
