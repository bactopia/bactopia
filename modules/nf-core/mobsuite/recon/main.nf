...
conda_tools   = "bioconda::mob_suite=3.1.6"
...
process MOBSUITE_RECON {
    ...
    container "${ workflow.containerEngine == 'singularity' && !params.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/mob_suite:3.1.6--pyhdfd78af_0' :
        'quay.io/biocontainers/mob_suite:3.1.6--pyhdfd78af_0' }"
