...
conda_tools   = "bioconda::bactopia-teton=1.0.5"
...
process KRAKEN2 {
    ...
    container "${ workflow.containerEngine == 'singularity' && !params.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/bactopia-teton:1.0.5--hdfd78af_0' :
        'quay.io/biocontainers/bactopia-teton:1.0.5--hdfd78af_0' }"
