...
conda_tools   = "bioconda::gubbins=3.3"
...
process GUBBINS {
    ...
    container "${ workflow.containerEngine == 'singularity' && !params.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/gubbins:3.3--py39pl5321h87d955d_0' :
        'quay.io/biocontainers/gubbins:3.3--py39pl5321h87d955d_0' }"
