...
conda_tools = "bioconda::kraken2=2.1.2 bioconda::bracken=2.7 bioconda::fastq-scan=1.0.1 conda-forge::pigz=2.6 conda-forge::pandas=1.5.2 conda-forge::python=3.10"
...
process KRAKEN2_BRACKEN {
    ...
    if [ "${params.bracken_read_length}" == "0" ]; then
        OBS_READ_LENGTH=\$(fastq-scan ${reads[0]} | jq -r '.read_length')
