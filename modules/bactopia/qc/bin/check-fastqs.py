...
if __name__ == '__main__':
    ...
    if args.fq1 and args.fq2:
        ...
        check_reads(r1["qc_stats"]["read_total"], args.sample, args.min_reads,
                    fq2=r2["qc_stats"]["read_total"])
        check_basepairs(r1["qc_stats"]["total_bp"], args.sample, args.min_basepairs,
        ...
        if args.runtype != "ont":
            ...
            check_reads(se["qc_stats"]["read_total"], args.sample, args.min_reads)
        check_basepairs(se["qc_stats"]["total_bp"], args.sample, args.min_basepairs)
